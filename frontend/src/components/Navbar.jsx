      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 shrink-0">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center font-black text-white text-lg shadow-sm"
              style={{ background: 'linear-gradient(135deg, #1a3a6e, #1e40af)' }}>
              F
            </div>
            <div>
              <div className="font-black text-[#1a3a6e] text-lg leading-none tracking-tight">Forsa</div>
              <div className="text-[10px] text-slate-400 leading-none">فرصة</div>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-slate-200 text-xs font-semibold text-slate-600 hover:border-[#1a3a6e] hover:text-[#1a3a6e] transition-colors bg-white"
            >
            ...
            <Link
              to="/admin"
              className={`hidden lg:block px-3 py-1.5 rounded-full text-xs font-semibold border transition-colors ${
                isActive('/admin')
        ...
        <div className="lg:hidden bg-white border-t border-slate-100 px-4 pb-4 pt-2">
          <div className="grid grid-cols-2 gap-1 mb-3">
            ...
            <Link
              to="/admin"
              onClick={() => setIsOpen(false)}
              className="px-4 py-2.5 rounded-xl text-sm font-medium text-slate-500 hover:bg-slate-50 text-center border border-slate-200"
            >
              {t('nav.admin')}
            </Link>
          </div>
